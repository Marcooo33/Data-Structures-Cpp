...
namespace lasd {
  ...
  public:
    ...
    template <typename Accumulator>
    Accumulator Fold(FoldFun<Data>, Accumulator) const;
  ...
  public:
    ...
    template <typename Accumulator>
    using FoldFun = typename TraversableContainer<Data>::FoldFun<Data>;

    template <typename Accumulator>
    Accumulator PreOrderFold(FoldFun<Data>, Accumulator) const;
  ...
  public:
    ...
    // Comparison operators
    bool operator==(const PostOrderTraversableContainer&) const noexcept; // Comparison of abstract types might be possible.
    bool operator!=(const PostOrderTraversableContainer&) const noexcept; // Comparison of abstract types might be possible.
    ...
    template <typename Accumulator>
    Accumulator PostOrderFold(FoldFun<Data>, Accumulator) const;
